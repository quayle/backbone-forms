;(function(Form, Editor) {
  ...
  QUnit.test("focus() - gives focus to editor and its selectbox", function() {
  ...
  QUnit.test("blur() - removes focus from the editor and its selectbox", function() {
    var editor = this.editor;
  ...
  QUnit.test("'change' event - is triggered when value of select changes", function() {
    var editor = this.editor;
  ...
  QUnit.test("'focus' event - bubbles up from the selectbox", function() {
    var editor = this.editor;
  ...
  QUnit.test("'blur' event - bubbles up from the selectbox", function() {
    var editor = this.editor;
